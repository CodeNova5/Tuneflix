...
`;
  ...
  return (
    <div className={styles.commentSection}>
      ...
      <div style={{ position: "fixed", bottom: "0", left:"0", width:"80%;", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 20px", borderTop: "1px solid #ccc" }}>
        <textarea
